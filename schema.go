...
type Schema struct {
	...
	DependentSchemas *orderedmap.OrderedMap[string, *Schema] `json:"dependentSchemas,omitempty"` // section 10.2.2.4
	...
	PatternProperties    *orderedmap.OrderedMap[string, *Schema] `json:"patternProperties,omitempty"`    // section 10.3.2.2
	...
	DependentRequired *orderedmap.OrderedMap[string, []string] `json:"dependentRequired,omitempty"` // section 6.5.4
...
type Definitions struct {
	*orderedmap.OrderedMap[string, *Schema]
}
